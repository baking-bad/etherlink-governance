...
class PayloadDecorationTestCase(BaseTestCase):
    ...
    def test_sequencer_upgrade_payload_decoration(self) -> None:
        ...
        assert proxy.get_sequencer_upgrade_payload(public_key, l2_address, activation_timestamp).hex() == expected_upgrade_payload
        ...
        public_key = 'sppk7ZZ62L7f1dep7ddYNhM2vsNuzouGzCrv9CRsxmJ6q4Cavys2fsk'
        l2_address = 'B7A97043983f24991398E5a82f63F4C58a417185'
        ...
        public_key = 'p2pk65aQziqHmuSpoEtEfaMRL4MwBMrSYQYoF3BCebocBKkg1shLepb'
        l2_address = 'B7A97043983f24991398E5a82f63F4C58a417185'
