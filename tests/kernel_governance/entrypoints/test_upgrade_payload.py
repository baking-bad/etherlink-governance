...
class KernelGovernanceUpgradePayloadTestCase(BaseTestCase):
    def test_generate_correct_payload(self) -> None:
        ...
        preimage_hash = bytes.fromhex('009279df4982e47cf101e2525b605fa06cd3ccc0f67d1c792a6a3ea56af9606abc')
        ...
        assert governance.get_upgrade_payload(preimage_hash, activation_timestamp).hex() == expected_upgrade_payload